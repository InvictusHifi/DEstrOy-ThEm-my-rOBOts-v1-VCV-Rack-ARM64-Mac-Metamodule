...
#include "dsp/skidder_engine.hpp"

#include <array>

class SkidderModule final : public CoreProcessor {
public:
    enum ParamId {
        RateParam, WidthParam, SlopeParam, FloorParam, RandomParam, StereoParam,
        ClockRatioParam, MixParam, ClockLockParam, ResetParam,
        RateAmountParam, WidthAmountParam, SlopeAmountParam, FloorAmountParam,
        RandomAmountParam, StereoAmountParam, ClockRatioAmountParam, MixAmountParam,
        NumParams
    };
    enum InputId {
        AudioLeftInput, AudioRightInput,
        RateCvInput, WidthCvInput, SlopeCvInput, FloorCvInput, RandomCvInput,
        StereoCvInput, ClockRatioCvInput, MixCvInput,
        ClockInput, ClockLockGateInput, ResetTriggerInput,
        NumInputs
    };
